...
/**
 * Audio & AI module — reads.
 *
 * Scoped by the `audio` grant through RLS, like every other module. Nothing
 * here touches the domains tables beyond resolving a resort name for display.
 */
