...
export function SpectrogramPlayer({ clip }: { clip: SpectrogramClip | null }) {
  ...
  async function togglePlay() {
    ...
    try {
      ...
      setError(t.audio.playbackBlocked);
    }
  }
    ...
    <div className="px-4 py-3.5">
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
        ...
        <p className={TYPE.meta}>
          {clip.sensorName ?? t.audio.unknownUnit}
      ...
      >
        {usePrecomputed && clip.spectrogramUrl ? (
          <img
            ...
            alt={fill(t.audio.spectrogramOf, { species: clip.speciesName })}
          ...
          <canvas
            ...
            aria-label={t.audio.liveSpectrogram}
            role="img"
          />
        )}
      ...
      {clip.audioUrl ? (
        <audio
          ...
          onError={() => setError(t.audio.clipLoadError)}
          className="hidden"
        />
      ) : (
