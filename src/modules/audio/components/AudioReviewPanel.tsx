...
} from "@/modules/audio/components/SpectrogramPlayer";
                ...
                <li key={clip.id}>
                  ...
                  >
                    ...
                    <span className={`mt-0.5 block ${TYPE.meta}`}>
                      {formatRelative(clip.detectedAt, now, t.relative)}
                      {clip.spectrogramUrl ? ` · ${t.audio.spectrogramOn}` : ""}
                      {!clip.audioUrl ? ` · ${t.audio.clipMissing}` : ""}
                    </span>
                  </button>
                </li>
              );
