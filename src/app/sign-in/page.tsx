  ...
  return (
    <main className="console-root flex min-h-screen items-center justify-center px-5 py-12">
      <div className="w-full max-w-[22rem]">
        <div className="mb-6">
          <p className="font-sans text-[13px] font-semibold tracking-[-0.01em] text-[var(--bt-text)]">
            BioTwin
          </p>
          <h1 className="mt-2 font-sans text-[18px] font-semibold tracking-[-0.015em] text-[var(--bt-text)]">
            Sign in
          </h1>
          <p className="mt-1 font-sans text-[12px] leading-relaxed text-[var(--bt-muted)]">
